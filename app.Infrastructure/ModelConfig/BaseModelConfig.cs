...
namespace app.Infrastructure.ModelConfig
{
    public class BaseModelConfig
    {
        public void ModelBuilderConfig(ModelBuilder builder)
        {
            ...
            new SalesOrderDetailsConfig()?.Configure(builder.Entity<SalesOrderDetail>());
            ...
            new AssetTransferConfig()?.Configure(builder.Entity<AssetTransfer>());
            new AssetTransferDetailConfig()?.Configure(builder.Entity<AssetTransferDetail>());
