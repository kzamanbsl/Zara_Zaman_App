...
//        {
//            AssetAllocationViewModel assetAssetAllocationModel = new AssetAllocationViewModel();
//            assetAssetAllocationModel = await Task.Run(() => (from t1 in _dbContext.AssetAllocation.Where(x => x.IsActive && x.Id == id)
//                                                            select new AssetAllocationViewModel
//                                                            {
//                                                                Id = t1.Id,
...
//            assetAssetAllocationModel.AssetAllocationDetailsList = await Task.Run(() => (from t1 in _dbContext.AssetAllocationDetail.Where(x => x.IsActive && x.AssetAllocation.Id == id)
//                                                                                          select new AssetAllocationDetailViewModel
//                                                                                          {
//                                                                                              Id = t1.Id,
//                                                                                              AssetAllocationId = t1.AssetAllocationId,
...
//            return assetAssetAllocationModel;
//        }
...
//        {
//            var assetAssetAllocation = _iEntityRepository.AllIQueryableAsync().FirstOrDefault(f => f.Id == vm.Id);
//            if (assetAssetAllocation != null)
//            {
//                assetAssetAllocation.Id = vm.Id;
//                assetAssetAllocation.PurchaseDate = vm.PurchaseDate;
//                assetAssetAllocation.SupplierId = vm.SupplierId;
//                assetAssetAllocation.StorehouseId = vm.StorehouseId;
//                await _iEntityRepository.UpdateAsync(assetAssetAllocation);
//                return true;
//            }
//            return false;
//        }
...
//        {
//            AssetAllocationViewModel assetPurchaseMasterModel = new AssetAllocationViewModel();
...
//            assetPurchaseMasterModel.AssetAllocationList = await Task.Run(() => dataQuery.ToList());
//            assetPurchaseMasterModel.AssetAllocationList.ToList().ForEach((c => c.OrderStatusName = Enum.GetName(typeof(AssetAllocationStatusEnum), c.OrderStatusId)));

//            var masterIds = assetPurchaseMasterModel.AssetAllocationList.Select(x => x.Id);
...
//                .ToListAsync();
//            foreach (var master in assetPurchaseMasterModel.AssetAllocationList)
//            {
