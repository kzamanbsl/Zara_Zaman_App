...
namespace app.WebApp.Controllers.JobManager
{
    public class LeaveBalanceController : Controller
    {
        ...
        {
            ViewBag.LeaveCategoryList = new SelectList((await _iDropdownService.LeaveCategorySelectionList()).Select(s => new { s.Id, s.Name }), "Id", "Name");
        ...
        [HttpPost]
        public async Task<IActionResult> Delete(LeaveBalanceSearchDto model)
        {
