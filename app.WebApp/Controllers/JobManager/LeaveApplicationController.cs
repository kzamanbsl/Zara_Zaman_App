...
namespace app.WebApp.Controllers.JobManager
{
    public class LeaveApplicationController : Controller
    {
        ...
        public async Task<IActionResult> AddRecord()
        {
            ...
            ViewBag.LeaveCategories = new SelectList((await _iDropdownService.LeaveCategorySelectionList()).Select(s => new { s.Id, s.Name }), "Id", "Name");
            ViewBag.Employees = new SelectList((await _iDropdownService.EmployeeSelectionList()).Select(s => new { s.Id, s.Name }), "Id", "Name");
            ViewBag.Managers = new SelectList((await _iDropdownService.EmployeeSelectionList()).Select(s => new { s.Id, s.Name }), "Id", "Name");
